...
export default function ProductDetail() {
  ...
  //Xử lí slider cho trang chi tiết sản phẩm
  ...
  const next = () => {
    if (currentIndexImages[1] < (product as ProductApi).images.length) {
  ...
  // goi api cac product lien quan
  const queryConfig: ProductListConfigApi = { limit: "20", page: "1", category: product?.category._id }
